...
<template>
  <div class="min-h-screen bg-[#ece9d8] text-gray-900 flex flex-col font-sans text-[12px]">
    <header class="bg-[#000080] text-white shadow-sm select-none border-b border-gray-400">
      <div class="max-w-[1360px] mx-auto px-2.5 py-1 flex items-center justify-between">
    ...
    <main class="w-full max-w-[1360px] mx-auto p-2 grid vb-layout items-start gap-2 min-h-0 overflow-auto">
      <!-- Left side: chart, 4 bottom boxes, send data strip & log -->
      <div class="flex flex-col gap-2 min-w-0">
        <WaveformChart class="h-[340px]" :state="driveState" />
        
        <div class="grid vb-left-boxes gap-2">
          <TelemetryPanel :state="driveState" class="h-full" />
          <DriverSettingsPanel :state="driveState" class="h-full" />
          <ModbusReadPanel
