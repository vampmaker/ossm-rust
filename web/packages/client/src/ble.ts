...
import type { MotorControllerConfig, PausedControlPayload, MotorState, PinConfiguration, NetworkConfiguration } from '@ossm/shared'

type BleT = (key: string, params?: Record<string, unknown>) => string
let bleT: BleT = (key) => key

export function bindBleI18n(t: BleT): void {
  bleT = t
}

const i18n = { global: { t: (key: string, params?: Record<string, unknown>) => bleT(key, params) } }
