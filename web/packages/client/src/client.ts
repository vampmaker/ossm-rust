...
export class OssmClient {
  ...
  public async getShellConfig(): Promise<ShellConfig> {
    return this.getJson<ShellConfig>('/shell-config')
  }

  public async setShellConfig(config: ShellConfig): Promise<ShellConfig> {
    return this.postJson<ShellConfig>('/shell-config', config)
  }
